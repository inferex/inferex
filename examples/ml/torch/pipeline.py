...
DATA_PATH = './data'
MODEL_FILE = './weights/mnist_cnn.pt'
...
def predict(payload: dict) -> dict:
    ...
    global cached_model  # ugh

    try:
        if cached_model is None:
            cached_model = Net()
            cached_model.load_state_dict(torch.load(MODEL_FILE))
            cached_model.eval()
...
if __name__ == '__main__':
    ...
    digit['digits'] = transform(np.array(digit['digits'])[0]).type('torch.DoubleTensor').unsqueeze(0)
